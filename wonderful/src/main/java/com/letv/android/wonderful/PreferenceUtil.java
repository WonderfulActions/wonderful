...
public class PreferenceUtil {
    ...
    public static void cacheLockVideo(final String url) {
        Log.i(Tags.WONDERFUL_PREFERENCE, "cacheLockVideo url = " + url);
    ...
    public static void cacheLockAlbum(final ArrayList<WonderfulVideo> videos) {
        Log.i(Tags.WONDERFUL_PREFERENCE, "cacheLockAlbum");
        if (videos != null && videos.size() > 0) {
            ...
            for (int i = 0; i < videos.size(); i++) {
                ...
                if (isDiskCacheAvailable) {
                    ...
                    Log.i(Tags.WONDERFUL_PREFERENCE, "cacheLockAlbum url = " + url);
                    Log.i(Tags.WONDERFUL_PREFERENCE, "cacheLockAlbum path = " + diskCachePath);
                }
            }
...
//        Log.i(Tags.WALLPAPER_ENGINE, "getLockVideoPath lockVideoPath = " + lockVideoPath);
    ...
    public static void setLockAlbumPaths(ArrayList<String> paths) {
        Log.i(Tags.WONDERFUL_PREFERENCE, "setLockAlbumPaths");
        final SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(WonderfulApplication.mContext);
        final Editor editor = preferences.edit();
        if (paths != null) {
    ...
    public static Set<String> getLockAlbumPaths(Context context) {
        final SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        final Set<String> lockAlbumPaths = preferences.getStringSet(KEY_LOCK_ALBUM_PATHS, null);
